...
/* Physics constants */
#define COMIC_GRAVITY           5   /* Gravity in normal levels (units of 1/8 game units per tick) */
...
#define JUMP_COUNTER_INITIAL    10  /* Initial value when jump starts (how many ticks can accelerate upward) */
