...
uint8_t comic_has_gems = 0;        /* 1 if Gems collected (Lake), 0 otherwise */
uint8_t comic_has_crown = 0;       /* 1 if Crown collected (Cave), 0 otherwise */
uint8_t comic_has_gold = 0;        /* 1 if Gold collected (Castle), 0 otherwise */
